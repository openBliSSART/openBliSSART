...
bool MFCCTest::performTest()
{
    ...
    {
        const Elem melData1[] = { 64.552, 47.181, 50.020, 60.640, 79.966, 
                                    ...
                                    160.975};
        const Elem melData2[] = { 89.907, 41.827, 43.779, 51.809, 66.028,
        ...
        cout << endl;
        const Elem mfccData1[] = { 31.205, -1.399, 0.496, 0.286, -0.540, 
        ...
        cout << endl;
        const Elem mfccLiftered1[] = { 31.205, -3.588, 2.034, 1.591, -3.754, 
        ...
        cout << endl;
        const Elem mfccData2[] = { 31.069, -1.455, 0.496, 0.255, -0.422,
...

    {
        ...
        const Elem data[] = { 1, 2, 3, 4, 5, 
                                2, 3, 4, 5, 6, 
                                1, 2, 3, 4, 5, 
                                2, 3, 4, 5, 6 };
        const Elem delta[] = { 0.5, 0.8, 1.0, 0.8, 0.5,
                                 0.5, 0.8, 1.0, 0.8, 0.5,
                                 0.5, 0.8, 1.0, 0.8, 0.5,
                                 0.5, 0.8, 1.0, 0.8, 0.5 };
